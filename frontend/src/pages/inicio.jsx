    ...
    return (
        <div className="w-full min-h-screen flex flex-col items-center px-4 sm:px-6 lg:px-12 pt-24 sm:pt-28 lg:pt-32">
            <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center lg:items-start justify-between gap-10 lg:gap-20">
                <div className="flex-1 text-center lg:text-left">
                    <span className="inline-block px-4 py-1.5 rounded-full text-sm font-medium bg-sky-100 text-sky-700 mb-5">
                    ...
                    <p className="text-base sm:text-lg lg:text-xl text-gray-600 mt-6 max-w-2xl mx-auto lg:mx-0">
                ...
                <div className="flex-shrink-0 relative">
                    ...
                    <div className="relative bg-white rounded-2xl shadow-lg border border-sky-100 p-6 sm:p-7 max-w-xs sm:max-w-sm">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-sky-400 to-blue-500 flex items-center justify-center text-white font-bold text-base shadow-sm">
                                IA
                            </div>
                            <div>
                        ...
                        <div className="mt-4 pt-4 border-t border-sky-50 grid grid-cols-2 gap-6 text-sm">
                            <div>
            ...
            <div className="w-full max-w-7xl mt-20 sm:mt-28 lg:mt-36 mb-16">
                <h2 className="text-2xl sm:text-3xl font-bold text-center mb-10">
                    <span className="bg-gradient-to-r from-sky-400 to-blue-500 text-transparent bg-clip-text">
                        Como funciona
                    </span>
