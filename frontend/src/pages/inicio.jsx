    ...
    return (
        <div className="w-full min-h-screen flex flex-col justify-start pl-50 pt-24 text-left">
            ...
            <div className="flex gap-4 mt-8">
                <Link to="/camera" className="flex items-center gap-2 bg-blue-500 text-white px-6 py-3 rounded-xl shadow-md hover:bg-blue-700 hover:shadow-lg transition-all duration-200">
                    <PlayIcon size={20} />
                    Comenzar Ahora
                </Link>
